...
class TransBaseModel(nn.Module):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--adapter_dimensions', type=int, default=768)
    ...
    def __init__(self, args, generator, sos_index):
        ...
        #Load 8 frame encoder model
            ...
            class Adapter(nn.Module):
                def __init__(self, embed_dim=768, adapter_dim=768):
            ...
            # Insert adapters into each transformer block
            adapter_dim = self.args.adapter_dimensions
            for block in self.encoder.model.blocks:
                block.adapter = Adapter(embed_dim=block.mlp.fc2.out_features, adapter_dim=adapter_dim)
