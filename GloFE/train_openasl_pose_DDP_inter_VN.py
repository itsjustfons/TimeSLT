...
parser = argparse.ArgumentParser()
    ...
    #pre-loaded corrnet weights
    parser.add_argument('--pre_trained', default = "true", help='load pre-trained corrnet weights')

    #pre-loade decoder weights
    parser.add_argument('--dec_pre_trained', default = "true", help='load pre-trained glofe decoder weights')
    
    #freeze corrnet weights
    parser.add_argument('--freeze_corrnet', default = "true", help='freeze corrnet weights')
