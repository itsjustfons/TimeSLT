torchrun /data/group1/z40575r/TimeSformer_GloFE/GloFE/train_how2_pose_DDP_inter_VN_TF_for_testing.py \
    --ngpus 4 \
    --work_dir_prefix "./timesformer_work_dir" \
    --work_dir "pretrain_dec_test/" \
    --bs 4 --ls 0.2 --epochs 400 \
    --save_every 1 \
    --clip_length 512 --vocab_size 23136 \
    --feat_path "/data/group1/z40575r/TimeSformer_GloFE/TimeSformer/datasets/how2sign/256" \
    --label_path "/data/group1/z40575r/CorrNet/how2sign/annotations/how2sign_trimmed_corrected.tsv" \
    --eos_token "</s>" \
