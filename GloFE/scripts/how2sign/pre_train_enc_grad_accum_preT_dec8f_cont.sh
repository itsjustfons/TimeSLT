torchrun /data/group1/z40575r/TimeSformer_GloFE/GloFE/train_how2_pose_DDP_inter_VN_TF.py \
    ...
    --dim_embedding 768\
    --dec_pre_trained "False"\
    --num_dec 4 \
    --dim_forward_dec 1024 \
    --nhead_dec 8\
    --resume 28\
    --weights "/data/group1/z40575r/TimeSformer_GloFE/pjsub/timesformer_work_dir/pretrain_dec_8f/phoenix_prefix-028.pt"\
    --frames16  "False"\
    --ts_overlap 2