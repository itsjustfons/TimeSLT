torchrun /data/group1/z40575r/TimeSformer_GloFE/GloFE/train_how2_pose_DDP_inter_VN_TF.py \
    ...
    --save_every 1 \
    --phase test \
    --weights "/data/group1/z40575r/TimeSformer_GloFE/pjsub/timesformer_work_dir/pretrain_dec_8f_heatmap/best-0.0081-at-018.pt"\
    --clip_length 512 --vocab_size 23136 \
    --feat_path "/data/group1/z40575r/CorrNet/how2sign/one_video" \
    --label_path "/data/group1/z40575r/CorrNet/how2sign/annotations/how2sign_realigned_combined_1vid.tsv" \
    --eos_token "</s>" \
