...
class OpenASLPoseDataset(Dataset):
    def __init__(self, arg_dict, tokenizer, phase='train', split='train'):
        ...
        #HACK
        #self.label_path = "/data/group1/z40575r/CorrNet/how2sign/annotations/how2sign_realigned_combined_1vid.tsv"
...
def eval(dataset, model, args, device, split, save_results: bool = False,
    ...
    eval_dataloader = DataLoader(
        dataset, batch_size=1, shuffle=False, drop_last=False, num_workers=8) #originally batch_size = args.bs, num_workers=8
...
def display_model_summary(model):
    ...
    print('-' * 65)
    print(f"{'Total Learnable Params':<50} {total_params:>15,}")
...
def main():
    ...
    if args.phase == 'train':
        ...
        print("load state dict test phase")
